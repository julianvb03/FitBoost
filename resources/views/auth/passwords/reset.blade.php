                        ...
                        <div class="form-control">
                            ...
                            <div class="relative">
                                <input id="password" type="password"
                                    ...
                                    placeholder="{{ trans('auth/auth.new_password_placeholder') }}" autofocus>
                                <svg class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-base-content/50"
                                    fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"
                            ...
                            <div id="password-strength" class="mt-2 hidden">
                                <div class="flex items-center space-x-2">
                                    <div class="text-xs text-base-content/70">{{ trans('auth/auth.password_strength') }}
                                    </div>
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative">
                                <input id="password-confirm" type="password"
                                    class="input input-bordered w-full pl-12 pr-12" name="password_confirmation" required

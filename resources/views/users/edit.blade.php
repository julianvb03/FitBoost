                                ...
                                <div class="form-control">
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button" onclick="togglePassword('password')"
                                            ...
                                            <svg id="password-eye" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                ...
                                <div class="form-control">
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button" onclick="togglePassword('confirm_password')"
                                            class="absolute right-3 top-1/2 transform -translate-y-1/2 text-base-content/60 hover:text-base-content">
                                            <svg id="confirm_password-eye" xmlns="http://www.w3.org/2000/svg"
        ...
        function updatePasswordStrength() {
            ...
            if (password.length === 0) {
                ...
                strengthText.className =
                    `text-sm mt-2 font-medium ${strength >= 3 ? 'text-success' : strength >= 2 ? 'text-warning' : 'text-error'}`;
            }
        }
